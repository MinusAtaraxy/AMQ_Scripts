...
let options = {
	images: [
        ...
        "https://w.wallhaven.cc/full/2e/wallhaven-2erxpm.png",
        "https://w.wallhaven.cc/full/ey/wallhaven-eyjglo.png"
	],
	...
	video: {
		url: "https://www.desktophut.com/files/1673479291-1673479291-genshin-impact-yae-miko-4-cybust-pc.mp4",//"https://desktophut-com.cdn.vidyome.com/videos/12-2018/kStWC5u7eyifonqthwFl.mp4", //another good one: "https://desktophut-com.cdn.vidyome.com/videos/04-2019/mySuBqs1CcijooCKJsOq.mp4", "https://www.desktophut.com/wp-content/uploads/2021/12/Anime-Ganyu-Girl-And-Rainy-Night-4K-Live-Wallpaper.mp4"
    ...
    transparent: [
        ...
        {
            selector: "#songHistoryWindow",
            opacity: 0.99
        },
        {
            selector: "#songHistoryInfoWindow",
            opacity: 0.99
        },
		{
        ...
        /*		{
		    selector: ".qpAvatarImageContainer",
			description: "backgound of avatar image in quiz",
			css: `.qpAvatarImageContainer {
                       box-shadow:none;
                   }`
		},
        */
        ...
        {
            selector: "#mpInstalled",
			description: "script thing",
			opacity: defaultOpacity
		},
		{
...
//		$("#qpAnimeNameContainer").css("visibility", "hidden");
	...
	extend(VideoOverlay, "show", function () {
		this.$hider.siblings().not('#qpVideoMainTextOverlay').css("visibility", "hidden");
        $("#qpAmqHintContainer").css("visibility", "visible");
	});
